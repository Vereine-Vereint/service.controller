...
declare -A borg_commands=(
  ...
  [restore-fresh]="<name> [--clean-git]:Delete and restore data from backup"
  [restore-diff]="<name> [--clean-git]:Restore data from backup (without deleting current data, using diff)"
